...
import { g as getVapidPublic, s as saveSubscription, c as countSubscriptions, r as removeSubscription, a as sendToUser } from "./push-DV3AKLI-.js";
import { r as runTick } from "./tick-Caixl4Sl.js";
...
const pushSubscribe = createServerFn({
  ...
  if (!data.endpoint || !data.p256dh) return {
    error: "Нет подписки"
  };
