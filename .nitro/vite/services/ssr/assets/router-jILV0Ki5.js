<<<<<<<< HEAD:.nitro/vite/services/ssr/assets/router-bVUirNDJ.js
import { f as functionalUpdate, h as arraysEqual, i as compileDecodeCharMap, k as createLRUCache, t as trimPath, l as rewriteBasepath, m as composeRewrites, p as processRouteTree, n as processRouteMasks, o as resolvePath, q as findRouteMatch, s as trimPathRight, u as findFlatMatch, v as deepEqual, w as isDangerousProtocol, x as loadRouteChunk, y as preloadClientRoute, z as findSingleMatch, D as DEFAULT_PROTOCOL_ALLOWLIST, A as buildRouteBranch, B as interpolatePath, C as isNotFound, E as isRedirect, F as nullReplaceEqualDeep, G as replaceEqualDeep, H as last, I as decodePath, J as executeRewriteInput, K as parseHref, L as hasKeys, M as executeRewriteOutput, N as encodePathLikeUrl, P as rootRouteId, Q as redirect, S as invariant, U as trimPathLeft, V as joinPaths, W as useRouter, r as reactExports, X as dummyMatchContext, Y as matchContext, Z as useForwardedRef, _ as exactPathTest, $ as removeTrailingSlash, a0 as React, j as jsxRuntimeExports, a1 as isModuleNotFoundError, a2 as reactUse, a3 as useHydrated, a4 as _getAssetMatches, a5 as escapeHtml, a6 as getAssetCrossOrigin, a7 as getScriptPreloadAttrs, a8 as appendUniqueUserTags, a9 as resolveManifestCssLink, T as TSS_SERVER_FUNCTION, aa as getServerFnById, c as createServerFn, O as Outlet } from "../server.js";
import { r as runTick } from "./tick-DRof54z-.js";
...
const isServer = true;
========
import { d as rootRouteId, t as trimPathLeft, j as joinPaths, e as trimPathRight, f as redirect, u as useRouter, r as reactExports, h as dummyMatchContext, m as matchContext, i as useForwardedRef, k as isDangerousProtocol, l as exactPathTest, n as removeTrailingSlash, o as hasKeys, p as deepEqual, q as functionalUpdate, s as React, v as jsxRuntimeExports, w as isModuleNotFoundError, x as reactUse, y as createNonReactiveReadonlyStore, z as createNonReactiveMutableStore, A as RouterCore, B as useHydrated, _ as _getAssetMatches, C as escapeHtml, D as getAssetCrossOrigin, E as getScriptPreloadAttrs, F as appendUniqueUserTags, G as resolveManifestCssLink, H as requireReact, T as TSS_SERVER_FUNCTION, I as getServerFnById, c as createServerFn, O as Outlet } from "../server.js";
import { r as runTick } from "./tick-CZ14g1aT.js";
>>>>>>>> e27f76616f1195142e46232034799f9498f1f9bd:.nitro/vite/services/ssr/assets/router-jILV0Ki5.js
var BaseRoute = class {
  get to() {
    return this._to;
  }
...
})).handler(createSsrRpc("806219a93b5cc06c2c17eafc4fa76cc75b8d67fab637b6aa9351eccd38a4b1e4"));
...
})).handler(createSsrRpc("98035567f6f469f9874b2b954f111d6d2ec227075fac1b278ca88ea009a22d9c"));
const getMe = createServerFn({
  method: "GET"
}).handler(createSsrRpc("728587076059dfd1edc0a493fb3be3934dcf259ab9d78920d235753f1f7dcb9e"));
const signOut = createServerFn({
  method: "POST"
}).handler(createSsrRpc("43ad8705b2fa1dd7627345116df7931c2bc1de1358f62cb5bfd9258d31ffb834"));
const bootstrapApp = createServerFn({
  method: "GET"
}).handler(createSsrRpc("9d398ff5ab695745178dbb88db2aed1ec541d32e09bf74c8a04cbf25d3fb0fed"));
...
const useLocal = create()(
  persist(
    (set, get) => ({
      ...
      setLastRoute: (r2) => set({ lastRoute: r2 })
    }),
    { name: "chekagent-v7" }
  )
);
const EMPTY_BOOT = {
  user: null,
  settings: { currency: "RUB", monthly_budget: 45e3, monthly_income: 0, allocations: {} },
  month: { key: "", spent: 0, budget: 45e3, left: 45e3, count: 0, byCategory: [] },
  receipts: [],
  bills: [],
  houses: []
};
...
function AppStateProvider({ children }) {
  ...
  const [boot, setBoot] = reactExports.useState(EMPTY_BOOT);
  ...
  const setSession = reactExports.useCallback((token, u) => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Ctx.Provider, { value, children }, void 0, false, {
    fileName: "/app/applet/src/lib/app-state.tsx",
    lineNumber: 95,
    columnNumber: 10
  }, this);
}
...
const MessageSquareQuote = createLucideIcon("message-square-quote", __iconNode$3);
const __iconNode$2 = [
  [
    "path",
...
<<<<<<<< HEAD:.nitro/vite/services/ssr/assets/router-bVUirNDJ.js
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto flex max-w-[430px] items-center justify-between rounded-[22px] border border-rule/80 bg-paper/95 px-2 py-1.5 shadow-paper-lg backdrop-blur-md", children: ITEMS.map((item) => {
========
      className: "fixed bottom-0 left-0 right-0 z-40 border-t border-rule bg-paper/95 backdrop-blur-sm",
      style: { paddingBottom: "env(safe-area-inset-bottom)" },
      children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mx-auto flex max-w-[430px] items-end justify-between px-3 pb-2 pt-1.5", children: ITEMS.map((item) => {
>>>>>>>> e27f76616f1195142e46232034799f9498f1f9bd:.nitro/vite/services/ssr/assets/router-jILV0Ki5.js
...
<<<<<<<< HEAD:.nitro/vite/services/ssr/assets/router-bVUirNDJ.js
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { size: 24, strokeWidth: 2.2 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute -top-1 -right-1 flex h-2.5 w-2.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-onsage/60 opacity-75" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative inline-flex h-2.5 w-2.5 rounded-full bg-onsage" })
                      ] })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 text-[10.5px] font-semibold tracking-wide text-sage", children: "Скан" })
========
                    children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(ScanLine, { size: 23, strokeWidth: 2 }, void 0, false, {
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[10px] text-muted", children: "Скан" }, void 0, false, {
                  fileName: "/app/applet/src/components/Nav.tsx",
                  lineNumber: 45,
                  columnNumber: 17
                }, this)
...
<<<<<<<< HEAD:.nitro/vite/services/ssr/assets/router-bVUirNDJ.js
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, strokeWidth: active ? 2.2 : 1.8 })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
...
========
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: cn("text-[10px]", active ? "text-sage" : "text-muted"), children: item.label }, void 0, false, {
                fileName: "/app/applet/src/components/Nav.tsx",
                lineNumber: 62,
                columnNumber: 15
              }, this)
...
const vapidPublic = createServerFn({
  method: "GET"
}).handler(createSsrRpc("c3215adfb5f9865a2a2c93996e0ccafa7e4497bfbfbc793f5b1b8ccf3a775460"));
const pushSubscribe = createServerFn({
  ...
  auth: String(d.auth || "")
})).handler(createSsrRpc("61b29505e69ceff365c03b7aac1f6465a099e1a3563c1a7a5b228cf4bc4ea13e"));
const pushUnsubscribe = createServerFn({
  method: "POST"
}).validator((d) => ({
  endpoint: String(d.endpoint || "")
})).handler(createSsrRpc("fc8a052b4119b198184206cb5264c457302d7d7d0a1dec123bbb2a3b69f97c9c"));
const pushTest = createServerFn({
  method: "POST"
}).handler(createSsrRpc("1d60935b5556c72b74df1f55a49c0f78c43950034b68b091a8fd79c0c715679e"));
const tickBills = createServerFn({
  method: "POST"
}).handler(createSsrRpc("6c22994192b1411130406524d62041368b9cf2312e40b099e2c69a47957148ac"));
...
async function enablePush() {
  ...
  try {
    ...
    const keys = json2?.keys || {};
    const res = await pushSubscribe({
      data: { endpoint: json2.endpoint, p256dh: keys.p256dh || "", auth: keys.auth || "" }
    });
    if (res?.error) return { ok: false, error: res.error };
    return { ok: true, endpoint: json2.endpoint ?? void 0 };
  } catch (e) {
    return { ok: false, error: e?.message || "Не получилось включить пуши" };
  }
}
function matchesKey(sub, publicKey) {
  try {
...
const Route$b = createRootRoute({
  head: () => ({
    ...
    styles: [
      {
        children: "html,body{margin:0;padding:0}html{background:#f3eee4;color-scheme:light}"
      }
    ]
  }),
  ...
  errorComponent: ({ error }) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "sheet items-center justify-center px-6 text-center", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "receipt-card rise w-full p-6", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "t-display text-[19px]", children: "Не получилось открыть" }, void 0, false, {
      fileName: "/app/applet/src/routes/__root.tsx",
      lineNumber: 57,
      columnNumber: 9
    }, void 0),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "t-muted mt-2 text-[14px]", children: error?.message || "Попробуйте обновить" }, void 0, false, {
      fileName: "/app/applet/src/routes/__root.tsx",
      lineNumber: 58,
      columnNumber: 9
    }, void 0)
  ...
  notFoundComponent: () => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "sheet items-center justify-center px-6 text-center", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "receipt-card rise w-full p-6", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "t-display text-[19px]", children: "Такого листка нет" }, void 0, false, {
      fileName: "/app/applet/src/routes/__root.tsx",
      lineNumber: 65,
      columnNumber: 9
    }, void 0),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "/", className: "mt-3 inline-block text-sage underline", children: "На меню" }, void 0, false, {
      fileName: "/app/applet/src/routes/__root.tsx",
      lineNumber: 66,
      columnNumber: 9
    }, void 0)
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("html", { lang: "ru", children: [
...
function RootComponent() {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(AppStateProvider, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Shell, {}, void 0, false, {
    fileName: "/app/applet/src/routes/__root.tsx",
    lineNumber: 92,
    columnNumber: 7
  }, this) }, void 0, false, {
...
function Shell() {
  ...
  if (!ready) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "sheet safe-top items-center justify-center", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "h-1.5 w-24 overflow-hidden rounded-full bg-rule", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "h-full w-1/3 animate-[breathe_1.4s_ease-in-out_infinite] rounded-full bg-sage" }, void 0, false, {
      fileName: "/app/applet/src/routes/__root.tsx",
      lineNumber: 122,
      columnNumber: 11
    }, this) }, void 0, false, {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "sheet safe-top", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("main", { className: bare ? "flex-1" : "safe-bottom flex-1", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Outlet, {}, void 0, false, {
      fileName: "/app/applet/src/routes/__root.tsx",
      lineNumber: 131,
      columnNumber: 9
    }, this) }, void 0, false, {
    ...
    !bare && user ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Nav, {}, void 0, false, {
      fileName: "/app/applet/src/routes/__root.tsx",
      lineNumber: 133,
      columnNumber: 24
    }, this) : null
...
<<<<<<<< HEAD:.nitro/vite/services/ssr/assets/router-bVUirNDJ.js
const $$splitComponentImporter$9 = () => import("./index-BspqchxG.js");
const Route$a = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./admin-Bt4A7sLw.js");
const Route$9 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./agent-BzM8QHIw.js");
const Route$8 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./bills-Bx2aHA-J.js");
const Route$7 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./groups-BW5Tb7Zj.js");
const Route$6 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./login-Djf43XRh.js");
const Route$5 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./receipts-Bqr8_vv5.js");
const Route$4 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./scan-DJemFb5N.js");
const Route$3 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./settings-BLMTpTLG.js");
const Route$2 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./groups._id-D0zG7wnn.js");
========
const $$splitComponentImporter$9 = () => import("./index-CDKkJz0O.js");
const Route$a = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./admin-CsQx0isv.js");
const Route$9 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./agent-4u405BUx.js");
const Route$8 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./bills-cRxNtwmx.js");
const Route$7 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./groups-CTTkWStF.js");
const Route$6 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./login--Sigf39U.js");
const Route$5 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./receipts-B3xZPcd2.js");
const Route$4 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./scan-oqf_la1P.js");
const Route$3 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./settings-B2P9bndG.js");
const Route$2 = createFileRoute()({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./groups._id-BETg4byO.js");
>>>>>>>> e27f76616f1195142e46232034799f9498f1f9bd:.nitro/vite/services/ssr/assets/router-jILV0Ki5.js
...
async function tick(request) {
  ...
  try {
    ...
    return json({ ok: false, error: e?.message || "сбой тика" }, 500);
  }
}
...
const AgentRoute = Route$8.update({
  id: "/agent",
  path: "/agent",
  getParentRoute: () => Route$b
});
const BillsRoute = Route$7.update({
  id: "/bills",
  path: "/bills",
  getParentRoute: () => Route$b
});
...
const ReceiptsRoute = Route$4.update({
  id: "/receipts",
  path: "/receipts",
  getParentRoute: () => Route$b
});
const ScanRoute = Route$3.update({
  id: "/scan",
  path: "/scan",
  getParentRoute: () => Route$b
});
...
const GroupsIdRoute = Route$1.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => GroupsRoute
});
const ApiPushTickRoute = Route2.update({
  id: "/api/push/tick",
  path: "/api/push/tick",
  getParentRoute: () => Route$b
});
const GroupsRouteChildren = {
  GroupsIdRoute
};
const GroupsRouteWithChildren = GroupsRoute._addFileChildren(GroupsRouteChildren);
