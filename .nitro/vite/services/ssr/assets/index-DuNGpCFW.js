import { a9 as getDefaultExportFromCjs, a8 as getAugmentedNamespace, aa as commonjsGlobal } from "../server.js";
import require$$0$2 from "events";
import require$$1$2 from "util/types";
...
function requirePgConnectionString() {
  ...
  function parse2(str, options = {}) {
    ...
    const fs = config.sslcert || config.sslkey || config.sslrootcert ? s__default : null;
    if (config.sslcert) {
...
function requireQuery$1() {
  ...
  class Query2 extends EventEmitter {
    ...
    hasBeenParsed(connection2) {
      return this.name && (connection2.parsedStatements[this.name] || connection2.submittedNamedStatements[this.name]);
    }
...
function requireHelper() {
  ...
  hasRequiredHelper = 1;
  (function(module) {
    var path = require$$0__default, Stream = require$$3.Stream, split = requireSplit2(), util = require$$0$4, defaultPort = 5432, isWin = process.platform === "win32", warnStream = process.stderr;
...
function requireLib$1() {
  ...
  hasRequiredLib$1 = 1;
  var fs = s__default, helper2 = requireHelper();
...
const require$$1$1 = /* @__PURE__ */ getAugmentedNamespace(esm);
var pgPool;
...
function requirePgPool() {
  ...
  class Pool2 extends EventEmitter {
    constructor(options, Client2) {
      ...
      this.Client = this.options.Client || Client2 || require$$1$1.Client;
...
function requireClient() {
  ...
  Client2.prototype._pulsePipelinedQueryQueue = function() {
    ...
    while (this._queryQueue.length > 0) {
      ...
      const values = query2.values ? query2.values.map(utils2.prepareValue) : null;
