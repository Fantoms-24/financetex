...
const Route$b = createRootRoute({
  ...
  errorComponent: ({ error }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sheet items-center justify-center px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "receipt-card rise w-full p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "t-display text-[19px]", children: "Не получилось открыть" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "t-muted mt-2 text-[14px]", children: error?.message || "Попробуйте обновить" })
  ] }) }),
  notFoundComponent: () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sheet items-center justify-center px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "receipt-card rise w-full p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "t-display text-[19px]", children: "Такого листка нет" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "mt-3 inline-block text-sage underline", children: "На меню" })
  ] }) }),
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppStateProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shell, {}) });
}
function Shell() {
  ...
  if (!ready) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sheet safe-top items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-24 overflow-hidden rounded-full bg-rule", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-1/3 animate-[breathe_1.4s_ease-in-out_infinite] rounded-full bg-sage" }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sheet safe-top", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: bare ? "flex-1" : "safe-bottom flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    !bare && user ? /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}) : null
  ] });
}
