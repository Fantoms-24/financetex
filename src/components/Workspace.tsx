...
import { ArrowUpRight, CalendarDays, LayoutDashboard, Moon, Plus, Receipt, Settings, Sparkles, Sun, Users, ScanLine } from 'lucide-react'
...
export function Workspace({ children }: { children: React.ReactNode }) {
  ...
  return <div className={`workspace ${path === '/agent' ? 'workspace-chat' : ''}`}>
    <aside className="workspace-sidebar">
      <Link to="/" className="brand"><Logo size={35} className="brand-symbol" />Листок<span className="brand-period">.</span></Link>
